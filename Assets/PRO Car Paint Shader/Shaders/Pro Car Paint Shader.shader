Shader "Pro Car Paint Shader"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting(inout SurfaceOutputCustomLightingCustom s,half3 viewDir,UnityGI gi)
		{
			...
			float2 uv_MetallicGlossMap = i.uv_ * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
			...
			float4 Reflection221 = (Reflection324 * GlobalSmoothness1481);
			...
			float4 lerp419 = lerp(lerp418,(_3DecalColor * tex2D1585),tex2D1585.a);
			float2 uv_4Decal = i.uv_ * _4Decal_ST.xy + _4Decal_ST.zw;
			float4 tex2D1581 = tex2D(_4Decal,uv_4Decal);
			float4 lerp420 = lerp(lerp419,(_4DecalColor * tex2D1581),tex2D1581.a);
			float2 uv_5Decal = i.uv_ * _5Decal_ST.xy + _5Decal_ST.zw;
			float4 tex2D1593 = tex2D(_5Decal,uv_5Decal);
			float4 lerp421 = lerp(lerp420,(_5DecalColor * tex2D1593),tex2D1593.a);
			float DecalsMask1627 = saturate((tex2D238.a + tex2D1589.a + tex2D1585.a + tex2D1581.a + tex2D1593.a));
			float4 Decals618 = lerp421;
			#endif
			#ifdef FLAKES
			#ifdef DECALS
			#ifdef DECALS_Under
			float lerp1518 = lerp((_Metallic * GlobalMetallic1480),_FlakesMetallic,FlakesMask1368);
			float lerp1524 = lerp((_Glossiness * GlobalSmoothness1481),_FlakesSmoothness,FlakesMask1368);
			...
			#else
			float4 temp = lerp((Decals618 + Reflection221),Reflection221,saturate(ref_fres * fresnel1320)); 
			...
			#endif
			#else
			float lerp1518 = lerp((_Metallic * GlobalMetallic1480),_FlakesMetallic,saturate(FlakesMask1368  - DecalsMask1627));
			float lerp1524 = lerp((_Glossiness * GlobalSmoothness1481),_FlakesSmoothness,saturate(FlakesMask1368  - DecalsMask1627));
			#ifdef REF
			...
			#else
			float4 Done = lerp((Decals618 + Reflection221),Reflection221,saturate(ref_fres * fresnel1320)); 
			#endif
			#else
			...
			#endif
			#else
			float lerp1518 = (_Metallic * GlobalMetallic1480);
			float lerp1524 = (_Glossiness * GlobalSmoothness1481);
			...
			float4 Done = Decals618;
			#else
			float4 Done = lerp((Decals618 + Reflection221),Reflection221,ref_fres); 
			#endif
			#else
			float4 Done = Decals618;
			#endif
			...
			s1359.Emission = (_EmissionColor * GlobalEmission1532).rgb;
			...
			s1455.Specular = ((GlobalMetallic1480 * 1.0)).xxx;
			s1455.Smoothness = (GlobalSmoothness1481 * _ClearCoatSmoothness);
			s1455.Occlusion = 1.0;
