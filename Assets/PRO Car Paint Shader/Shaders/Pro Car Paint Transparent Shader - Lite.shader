Shader "Hidden / Pro Car Paint Transparent Shader - Lite"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting(inout SurfaceOutputCustomLightingCustom s,half3 viewDir,UnityGI gi)
		{
			...
			float4 Decals618 = Two_927;
			float DecalsMask1627 = saturate((tex2D238.a + tex2D1333.a));
			#endif
			#ifdef REF
			#ifdef REF_Under
			...
			result.rgb  = lerp(((screenColor1285 + screenColor1295 + screenColor1293 + screenColor1300 + screenColor1299 + screenColor1296 + screenColor1297 + screenColor1294 + screenColor1298)/ 9.0),float4(surfResult1265,0.0),lerp(1.0,(1.0 - _Cutoff),(tex2D605.b * tex2D605.a)));
			#else
			result.rgb  = lerp(screenColor1285,float4(surfResult1265,0.0),lerp(1.0,(1.0 - _Cutoff),(tex2D605.b * tex2D605.a)));
			#endif
			result.a = 1;
			return result;
		}
